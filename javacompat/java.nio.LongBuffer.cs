namespace java.nio
{
    public sealed class LongBuffer : global::java.nio.Buffer
    {
        ...
        private long ElemGet(int i) { return arr != null ? arr[i] : VStore().ReadBytes(voff + i * 8, 8, vlittle); }
        private void ElemSet(int i, long v) { if (arr != null) { arr[i] = v; } else { VStore().WriteBytes(voff + i * 8, 8, v, vlittle); } }
